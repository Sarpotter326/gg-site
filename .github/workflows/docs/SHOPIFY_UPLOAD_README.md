...
1. Add repository secrets:
   - SHOP_DOMAIN = cqdugz-jq.myshopify.com
...
3. From the Actions tab, run the "Upload Charms to Shopify" workflow (workflow_dispatch).
   ...
   SHOP_DOMAIN=cqdugz-jq.myshopify.com SHOPIFY_ACCESS_TOKEN=shpat_xxx node scripts/upload-create-charm-products.js public/Charms
