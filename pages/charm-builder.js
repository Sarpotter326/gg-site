...
// Define the available charms by category.
// Feel free to adjust the labels, IDs and prices, or add more items.
const CHARM_OPTIONS = {
  Birthstones: [
    { id: 'BS01', label: 'Garnet (Jan)', price: 15 },
    { id: 'BS02', label: 'Amethyst (Feb)', price: 15 },
    { id: 'BS03', label: 'Aquamarine (Mar)', price: 15 },
  ],
  Initials: [
    { id: 'IN01', label: 'A', price: 10 },
    { id: 'IN02', label: 'B', price: 10 },
    { id: 'IN03', label: 'C', price: 10 },
  ],
  Animals: [
    { id: 'AN01', label: 'Butterfly', price: 12 },
    { id: 'AN02', label: 'Heart', price: 12 },
    { id: 'AN03', label: 'Star', price: 12 },
  ],
  'Sea & Beach': [
    { id: 'SB01', label: 'Seashell', price: 12 },
    { id: 'SB02', label: 'Starfish', price: 12 },
    { id: 'SB03', label: 'Wave', price: 12 },
  ],
};
