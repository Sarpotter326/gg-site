    ...
    >
      <div className="flex items-center gap-3 px-6 py-6 border-b">
        ...
        <span
          ...
          style={{ fontFamily: 'Quicksand, Avenir, sans-serif', color: '#CBB292' }}
        >
          Grace &amp; Gold Co.
        </span>
      </div>
...
export default function Home() {
  ...
  // Local product array; extend this list as needed
  const products = [
        ...
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <Link href="/" legacyBehavior>
              <a className="text-2xl font-extralight tracking-tight" style={{ fontFamily: 'Quicksand, Avenir, sans-serif', color: '#CBB292', letterSpacing: '0.08em', textDecoration: 'none' }}>
                Grace &amp; Gold Co.
              </a>
            </Link>
          </div>
      ...
      <section className="mx-auto grid max-w-5xl items-center gap-12 px-6 py-16 sm:px-8 lg:grid-cols-2 lg:py-20 lg:px-12">
        <div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <a href="#shop" className="rounded-full bg-[#B76E79] px-7 py-3 text-base font-semibold text-white shadow-sm hover:bg-[#F5E2DA] hover:text-[#B76E79] transition">
              Shop charms
            </a>
            <a href="#book" className="rounded-full border border-[#B76E79] px-7 py-3 text-base font-semibold text-[#B76E79] hover:bg-[#F5E2DA] transition">
              Book an event
            </a>
          </div>
        </div>
